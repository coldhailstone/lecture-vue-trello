            ...
            <div class="board">
                ...
                <div class="list-section-wrapper">
                    <div class="list-section">
                        <div class="list-wrapper" v-for="list of board.lists" :key="list.pos">
                            <list :data="list"></list>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    updated() {
        ...
        this.dragulaCards = dragula([...Array.from(this.$el.querySelectorAll('.card-list'))]).on('drop', (el, wrapper, target, siblings) => {
            const targetCard = {
